...
def index():
    ...
    return render_template('index.html',message="Welcome to the Home Page",trending_products=trending_products.head(8),truncate = truncate,
...
def main():
    trending_products = [
        {'Name': 'Product 1', 'Brand': 'Brand A', 'ReviewCount': 25, 'Rating': 4.5, 'Price': '$20'},
        {'Name': 'Product 2', 'Brand': 'Brand B', 'ReviewCount': 15, 'Rating': 4.0, 'Price': '$30'}
    ]
    return render_template('main.html', trending_products=trending_products)
...
def recommendations():
    if request.method == 'POST':
        ...
        if content_based_rec.empty:
            ...
            # Pass content_based_rec as an empty DataFrame when no recommendations are available
